...
const ERRORS: { [key: string]: HttpError } = {
  ...
  ERR_VALIDATION_FAILED: new HttpError("ERR_VALIDATION_FAILED", 400),
  ...
  ERR_ROUTE_NOT_FOUND: new HttpError(
    "ERR_ROUTE_NOT_FOUND",
    404
  ),
   ...
   * -- ORDERS --
   */
  ERR_ORDER_NOT_FOUND: new HttpError("ERR_ORDER_NOT_FOUND", 404),
};
